    ...
    <div id="divMid">
        <form action="" method="">
            <div id="divContent">            
                ...
                <br>
                <img src="./images/addThumbnail.png" 
                ...
                <br>
                <span>상세 내용</span><br>
                <textarea cols="70" rows="5" style="resize:none;margin-left: 15px;" name="detail" placeholder="상세 내용"></textarea>
                <br>
            </div>
            <div id="divBtn">
                <button id="insertBtn">가구 수정하기</button>
            </div>        
        </form>
    </div>
