...
public class OrderController extends QuartzJobBean { // extends QuartzJobBean
	...
	public ModelAndView orderSheet(ModelAndView mv, @RequestParam(value = "productNo") int[] productNos) {
...
//		
	...
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		...
		// HttpSession
		// httpSession=(HttpSession)(RequestContextHolder.currentRequestAttributes().resolveReference(RequestAttributes.REFERENCE_SESSION));
