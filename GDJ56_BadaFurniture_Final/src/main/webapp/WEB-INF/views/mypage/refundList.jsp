...
<style>
	...
	table#refundTable tr>th:first-child, td.td1{
		width:550px;
	}
	table#refundTable tr>th:nth-child(2), td.td2{
		width:250px;
	}
	td.td1{
		text-align:left !important;
	}
	table#refundTable tr>th:nth-child(3), td.td3{
		width:150px;
	}
	table#refundTable tr>th:nth-child(4), td.td4{
		width:150px;
	}
	table#refundTable tr>th:nth-child(5), td.td5{
		width:150px;
	}
	table#refundTable tr>th:nth-child(6), td.td6{
		width:150px;
	}
...
<script>
	...
	$("button.searchAll").click(e=>{
		location.assign("${path}/mypage/refund.do");
	});
